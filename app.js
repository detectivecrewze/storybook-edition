(function () {
  ...
  function renderMusic() {
    ...
    player.innerHTML = `<div class="music-poster"><span class="poster-tape" aria-hidden="true"></span><div class="vinyl-disc" aria-hidden="true"><span>FOR<br>YOU</span></div><div class="album-art"><img alt="" hidden><span>♫</span></div></div><div class="music-panel"><div class="track-copy"><small>SONG DEDICATED FOR YOU · <b></b></small><h3></h3><p></p></div><blockquote class="song-note" hidden><span class="song-note__label"></span><p class="song-note__text"></p></blockquote><p class="music-error" role="status" hidden></p><div class="progress-row"><span class="current-time">0:00</span><input class="seek" type="range" min="0" max="100" value="0" aria-label="Song progress"><span class="duration-time">0:00</span></div><div class="player-controls"><button class="round-button track-prev" type="button" aria-label="Previous song">←</button><button class="play-button" type="button" aria-label="Play"><svg class="play-icon" viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true"><path d="M8 5.5v13a.8.8 0 0 0 1.2.7l10.5-6.5a.8.8 0 0 0 0-1.4L9.2 4.8a.8.8 0 0 0-1.2.7z"/></svg><svg class="pause-icon" viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden="true" hidden><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg></button><button class="round-button track-next" type="button" aria-label="Next song">→</button></div><div class="playlist"></div></div>`;
    ...
    const syncPlay = () => { const playing = !storyAudio.paused; const playIcon = $(".play-icon", player); const pauseIcon = $(".pause-icon", player); if (playIcon) playIcon.hidden = playing; if (pauseIcon) pauseIcon.hidden = !playing; $(".play-button", player)?.setAttribute("aria-label", playing ? "Pause" : "Play"); $(".vinyl-disc", player).classList.toggle("is-playing", playing); };
