(function () {
  ...
  function renderMusic() {
    ...
    const syncPlay = () => { const playing = !storyAudio.paused; const playButton = $(".play-button", player); if (playButton) { playButton.classList.toggle("is-playing", playing); playButton.setAttribute("aria-label", playing ? "Pause" : "Play"); } $(".vinyl-disc", player)?.classList.toggle("is-playing", playing); };
